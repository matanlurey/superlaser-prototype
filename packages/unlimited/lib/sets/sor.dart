/// Card data for _Spark of Rebellion_.
///
...
/// SOR 002: **Iden Versio** - Inferno Squad Commander.
///
...
/// SOR 003: **Chewbacca** - Walking Carpet.
///
...
/// SOR 005: **Luke Skywalker** - Faithful Friend.
///
...
/// SOR 006: **Emperor Palpatine** - Galactic Ruler.
///
...
/// SOR 007: **Grand Moff Tarkin** - Oversector Governor.
///
...
/// SOR 008: **Hera Syndulla** - Spectre Two.
///
...
/// SOR 009: **Leia Organa** - Alliance General.
///
...
/// SOR 010: **Darth Vader** - Dark Lord of the Sith.
///
...
/// SOR 011: **Grand Inquisitor** - Hunting the Jedi.
///
...
/// SOR 012: **IG-88** - Ruthless Bounty Hunter.
///
...
/// SOR 013: **Cassian Andor** - Dedicated to the Rebellion.
///
...
/// SOR 014: **Sabine Wren** - Galvanized Revolutionary.
///
...
/// SOR 015: **Boba Fett** - Collecting the Bounty.
///
...
/// SOR 016: **Grand Admiral Thrawn** - Patient and Insightful.
///
...
/// SOR 017: **Han Solo** - Audacious Smuggler.
///
...
/// SOR 018: **Jyn Erso** - Resisting Oppression.
///
...
/// SOR 031: **Inferno Four** - Unforgetting.
///
...
/// SOR 056: **Bendu** - The One in the Middle.
///
...
/// SOR 079: **Admiral Piett** - Captain of the Executor.
///
...
/// SOR 105: **General Krell** - Heartless Tactician.
///
...
/// SOR 128: **Death Star Stormtrooper**.
///
...
/// SOR 152: **For a Cause I Believe In**.
///
...
/// SOR 156: **Benthic "Two Tubes"** - Partisan Lieutenant.
///
...
/// SOR 201: **Bodhi Rook** - Imperial Defector.
///
...
/// SOR 204: **Greedo** - Slow on the Draw.
///
...
/// SOR 236: **R2-D2** - Ignoring Protocol.
///
...
/// All cards in _Spark of Rebellion_.
///
...
final cards = /*<Card>*/[
  ...
  admiralPiett,
  generalTagge,
  seasonedShoretrooper,
  emperorsRoyalGuard,
  superlaserTechnician,
  grandMoffTarkinDeathStarOverseer,
  rukh,
  gladiatorStarDestroyer,
  darthVaderCommandingTheFirstLegion,
  blizzardAssaultAtAt,
  relentless,
  devastator,
  theEmperorsLegion,
  ...
  admiralOzzel,
  firstLegionSnowtrooper,
  fifthBrother,
  imperialInterceptor,
  seventhSister,
  ruthlessRaider,
  emperorPalpatineMasterOfTheDarkSide,
  vadersLightsaber,
  fallenLightsaber,
  forceLightning,
  forceChoke,
  ...
  bibFortuna,
  cartelSpacer,
  bobaFettDisintegrator,
  seventhFleetDefender,
  jabbaTheHutt,
  bossk,
  bountyHunterCrew,
  fettsFirespray,
  ...
  iHadNoChoice,
  chopper,
  leiaOrganaDefiantPrincess,
  lothalInsurgent,
  vanguardAce,
  ezraBridger,
  millenniumFalcon,
  rogueOperative,
  auzituckLiberatorGunship,
  chewbaccaLoyalCompanion,
  landoCalrissian,
  hanSoloReluctantHero,
  bamboozle,
  sparkOfRebellion,
  bodhiRook,
  cantinaBouncer,
